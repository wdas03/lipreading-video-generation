...
class TrainableAudioEncoder(nn.Module):
    def __init__(self, model_name="facebook/wav2vec2-base"):
        super(TrainableAudioEncoder, self).__init__()
        self.encoder = Wav2Vec2ForCTC.from_pretrained(model_name, cache_dir=CACHE_DIR).wav2vec2
        
    def forward(self, waveform):
        embeddings = self.encoder(waveform).last_hidden_state
        return embeddings
